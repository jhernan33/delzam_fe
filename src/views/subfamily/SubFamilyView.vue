...
export default {
  ...
  methods: {
    ...
    listadoSubFamily() {
      ...
      SubFamilyDataService.getAll(page,itemsPerPage)
        .then((response) => {
          this.loading = false;
    ...
    searchFamily() {
      SubFamilyDataService.findByFamily(this.search)
        .then((response) => {
          this.loading = true;
          this.subfamily = response.data.results.map(this.getDisplaySubFamily);
          this.totalFamily = response.data.count;
    ...
    getDisplaySubFamily(Object) {
      return {
        id: Object.id,
        desc_sufa: Object.desc_sufa,
        abae_sufa: Object.abae_sufa,
        agru_sufa: Object.agru_sufa,
